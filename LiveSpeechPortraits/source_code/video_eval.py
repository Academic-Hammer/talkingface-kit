...
# 主流程，只保留FID计算
def compute_fid_for_videos(gt_video, gen_video, output_dir, target_fps=30):
    # 获取视频信息
...
if __name__ == "__main__":
    gt_video_path = "data\Input\Obama01.mp4"
    gen_video_path = "results\Obama1\Obama01\Obama01.avi"
    output_dir = "./evaluation_output"
    os.makedirs(output_dir, exist_ok=True)

    fid_value = compute_fid_for_videos(gt_video_path, gen_video_path, output_dir, target_fps=30)
