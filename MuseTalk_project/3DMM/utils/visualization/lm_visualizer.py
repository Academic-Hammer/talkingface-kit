...
def render_idexp_npy_to_lm_video(npy_name, out_video_name, audio_name=None):
    ...
    for i_img in range(len(lm3d)):
        ...
        img = np.ones([WH+50, WH+50, 3], dtype=np.uint8) * 255
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--npy_name', type=str, default="infer_out/Obama/pred_lm3d/origin.npy", help='the path of landmark .npy')
    argparser.add_argument('--audio_name', type=str, default="data/raw/val_wavs/origin.wav", help='the path of audio file')
    argparser.add_argument('--out_path', type=str, default="visualized_lm3d/origin.mp4", help='the path to save visualization results')
